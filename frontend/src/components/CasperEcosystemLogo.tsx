...
export function CasperEcosystemLogo({
  className = "",
  size = 32,
  ...
  return (
    <div className={`flex items-center select-none ${className}`}>
      ...
      {/* 2. SPACING GAP: Set to width of lowercase 'a' (roughly 12px for size 32) */}
      ...
      <span
        ...
        className="font-bold tracking-tight text-white dark:text-white light:text-[#0B1B95] font-display select-none transition-colors duration-300"
      >
        Casper
      </span>
...
export default CasperEcosystemLogo;